...
def parse_args():
    ...
    parser.add_argument('--load_ckpt', default='/media/SSD_1TB/zzy/ApolloScape/ECCV2018_apollo/train/Dec05-22-04-08_n606_step/ckpt/model_step19999.pth', help='checkpoint path to load')
